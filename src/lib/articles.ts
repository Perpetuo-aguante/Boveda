...
/**
 * El orden de abajo no es cronológico: cicla Estelar → El Creativo →
 * Anteojos → Estelar…, tomando de cada sección el texto más reciente que le
 * quede, para que el puesto, el índice y el anterior/siguiente nunca hagan
 * dos textos seguidos de la misma sección. Anteojos se agota antes que las
 * otras dos (14 en vez de 15), así que el ciclo pierde ese tercer paso al
 * final; «Alegoría en sueños», la única «Sin clasificar», no entra en el
 * ciclo por no tener sección que rotar y queda al cierre.
 */
