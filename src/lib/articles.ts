...
/**
 * El orden de abajo es curatorial, decidido a mano por Tomás; no sigue
 * ninguna regla de fecha ni de sección. «Alegoría en sueños», la única «Sin
 * clasificar», queda al cierre por no haber entrado en esa selección.
 */
export const articulos: Articulo[] = [
  ...
  },
  {
    ...
    acceso: "abierto",
    url: "",
    imagen: "/portadas/mexico-a-dos-anos-de-sheinbaum-manuel-pedrero.webp",
    resumen: "",
    porQue: "",
  ...
  },
  {
    ...
    acceso: "abierto",
    url: "",
    imagen: "/portadas/odiar-sin-limites.webp",
    resumen: "",
    porQue: "",
  ...
  },
  {
    ...
    acceso: "abierto",
    url: "",
    imagen: "/portadas/mexico-a-dos-anos-de-sheinbaum-natalia-torres.jpg",
    resumen: "",
    porQue: "",
  ...
  },
  {
    ...
    acceso: "abierto",
    url: "",
    imagen: "/portadas/la-trampa.jpg",
    resumen: "",
    porQue: "",
  },
  {
    slug: "no-me-quiero-ir-de-aqui",
    titulo: "No me quiero ir de aquí",
    autor: "Sofía Otero",
    fecha: "2025-10-20",
    seccion: "Estelar",
    acceso: "abierto",
    url: "",
    imagen: "/portadas/no-me-quiero-ir-de-aqui.webp",
    resumen: "La comunidad costera que se resiste al desplazamiento.",
    porQue: "",
    bio: "Sofía Otero es una periodista originaria de Cancún, Quintana Roo. Se dedica al análisis político y social desde una perspectiva crítica y de izquierda. Es editora de Política en Perpetuo, y ha colaborado en medios como *Volcánicas*, *Milenio*, *Posta*, *N+* y *Nexos*.",
  },
  {
